...
<body>
    <section class = "skills section" id="skills">
        ...
        <div>
            ...
            <div class ="skills_content skills_open">
              ...
              <i class="uil uil-angle-down skills_arrow">
            
                
            </div>  
    
    <!--==== ce que l'on retrouve dans le menu déroulant=====-->
    <!--==== à coller 3Xdans le menu deroulant=====-->
    <!--==== début =====-->
    ...
    <div class ="skills_content_close">
                <div class ="skills_header">
                    <i class="uil uil-swatchbook skill_icon"></i>
    
                    <div>
                        <h1 class ="Skills_title"> Designer</h1>
                        <span class ="skills_subtitle"> Plus de 5 ans </span>
    ...
    <div class="skills_data">
        ...
        <span class="skills_number">85%</span>
         ...
         <div class="skills_bar">
             <span class="skills_percentage skills_photpshop"></span>
